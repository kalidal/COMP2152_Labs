...
class Finding:
    ...
    def __eq__(self, other):
        # Objects are equal if both subdomain and title match
...
class Report:
    ...
    def __add__(self, other):
        # Combine two reports into a brand new Report object
        new_name = f"Merged: {self.team_name} + {other.team_name}"
        new_report = Report(new_name)
